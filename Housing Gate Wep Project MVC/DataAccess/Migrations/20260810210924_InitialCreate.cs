        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_OwnerProfiles_UserId", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VerifiedStayCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_OwnerProfiles_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptsSmokers = table.Column<bool>(type: "bit", nullable: false),
                    PreferredSleepSchedule = table.Column<int>(type: "int", nullable: true),
                    PreferredNoiseLevel = table.Column<int>(type: "int", nullable: true),
                    PreferredCleanliness = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoommatePreferences_StudentProfiles_StudentProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetPropertyId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Complaints_Properties_TargetPropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyApplications_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyApplications_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stays_PropertyApplications_ApplicationId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Stays_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyReviews_AspNetUsers_ReviewerId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyReviews_Stays_StayId",
                        column: x => x.StayId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserReviews_Stays_StayId",
                        column: x => x.StayId,
                        principalTable: "Stays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_TargetPropertyId",
                table: "Complaints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_ApprovalStatus_IsActive",
                table: "Properties",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyApplications_RoomId_Status",
                table: "PropertyApplications",
                columns: new[] { "RoomId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_PropertyApplications_StudentProfileId",
                table: "PropertyApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyReviews_StayId_ReviewerId",
                table: "PropertyReviews",
                columns: new[] { "StayId", "ReviewerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoommatePreferences_StudentProfileId",
                table: "RoommatePreferences",
                column: "StudentProfileId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_PropertyId_IsAvailable",
                table: "Rooms",
                columns: new[] { "PropertyId", "IsAvailable" });

            migrationBuilder.CreateIndex(
                name: "IX_Stays_ApplicationId",
                table: "Stays",
                column: "ApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Stays_RoomId_Status",
                table: "Stays",
                columns: new[] { "RoomId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Stays_StudentProfileId",
                table: "Stays",
                column: "StudentProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_StayId_ReviewerId_ReviewedUserId",
                table: "UserReviews",
                columns: new[] { "StayId", "ReviewerId", "ReviewedUserId" },
                unique: true);
        }
